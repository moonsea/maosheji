<%@page import="maosheji.core.util.TokenUtil"%>
<%@page import="maosheji.core.front.SystemManager"%>
<%@page import="maosheji.services.front.product.bean.Product"%>
<%@page import="maosheji.services.front.product.ProductService"%>
<%@page import="org.springframework.web.context.support.WebApplicationContextUtils"%>
<%@page import="org.springframework.web.context.WebApplicationContext"%>
<%@page import="com.opensymphony.xwork2.ActionContext"%>
<%@page import="org.apache.commons.lang.StringUtils"%>
<%@page import="java.util.*"%>
<%@page import="maosheji.services.front.news.bean.News"%>
...
<%-- 												id:<s:property value="id" escape="false"/><br> --%>
			...
			<%-- 				<div class="alert alert-danger">暂时还没有收获地址！<a href="<%=request.getContextPath() %>/user/address.html">设置</a></div> --%>
					...
					<li class="list-group-item">
						<a href="#" data-toggle="tooltip" title="请选择配送方式！" id="expressTips"></a>
							<span class="glyphicon glyphicon-send"></span>&nbsp;配送方式
						
					</li>
					<li class="list-group-item" >
						<div class="row">
							<div class="col-xs-12">
							<!-- <input type="radio" checked="checked" value="POST" name="e.expressCode"/>包邮-->
								<table class="table table-bordered table-hover" id="expressTable">
										<tr style="cursor: pointer;">
											<td width="400px">
											<input type="radio" name="e.expressCode" value="POST" fee="0"/>包邮
											</td>
										</tr>
								</table>
							</div>
