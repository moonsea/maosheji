...
<%@page import="maosheji.web.action.front.orders.CartInfo"%>
<%@page import="maosheji.services.front.product.bean.Product"%>
<%@page import="maosheji.core.FrontContainer"%>
<%@page import="maosheji.services.front.catalog.bean.Catalog"%>
...
<!-- 			style="position: fixed;top: 0px;text-align: right;border: 2px solid red;z-index: 10000;"> -->
	<div class="container" style="min-height: 10px;margin-top:5px;margin-bottom:5px;border: 0px solid red;">
		<div class="row">
			<div class="col-xs-3">
				<a href="<%=SystemManager.systemSetting.getWww()%>"><img style="max-height: 100px;" alt="myshop-logo" src="<%=SystemManager.systemSetting.getLog()%>"/></a>
			</div>
