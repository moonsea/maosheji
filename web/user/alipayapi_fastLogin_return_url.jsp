...
<%@page import="maosheji.web.action.manage.account.AccountAction"%>
<%@page import="org.slf4j.LoggerFactory"%>
<%@page import="org.slf4j.Logger"%>
<%@page import="maosheji.services.front.account.AccountService"%>
<%@page
	import="org.springframework.web.context.support.WebApplicationContextUtils"%>
<%@page import="org.springframework.web.context.WebApplicationContext"%>
<%@page import="maosheji.core.front.SystemManager"%>
<%@page import="maosheji.services.front.account.bean.LoginTypeEnum"%>
<%@page import="maosheji.services.front.account.bean.Account"%>
<%@page import="maosheji.core.ManageContainer"%>
<%@page import="maosheji.core.pay.alipay.alipayescow.util.AlipayNotify"%>
<%
	/* *
	 功能：支付宝页面跳转同步通知页面
	 版本：3.2
